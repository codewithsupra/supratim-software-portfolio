  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-zinc-800" role="contentinfo">
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-24 py-12">
            ...
            <ul className="flex items-center gap-4" role="list">
              <li>
                <a
                  ...
                  aria-label="GitHub"
                  className="w-10 h-10 rounded-full border border-zinc-800 flex items-center justify-center text-zinc-500 hover:text-white hover:border-zinc-600 transition-all focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-400"
                >
        ...
        <div className="mt-10 pt-8 border-t border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-zinc-700 text-sm">
            © {year} Supratim Sarkar. All rights reserved.
          </p>
